  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 text-[#2563eb]">Usage Policy</h1>
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">1. Acceptable Use</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">2. Prohibited Activities</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">3. Account Responsibilities</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">4. Service Limitations</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">6. Modifications to Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">7. Contact Information</h2>
            <p>
