  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-primary/5 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="shadow-2xl border border-gray-200 bg-[#050C1A]/80 backdrop-blur">
          <CardHeader className="text-center pb-6">
            <CardTitle className="text-2xl font-bold text-white">Welcome Back</CardTitle>
            <CardDescription className="text-gray-500">Sign in to access your BtcCloudBase dashboard</CardDescription>
          </CardHeader>

          {authError && (
            <div className="mx-6 mb-4 rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-2 text-sm text-red-600">
              {authError}
            </div>
          )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="relative mt-1">
                  ...
                  <Input
                    ...
                    className={`pl-10 bg-white/5 text-white ${
                      formErrors.email ? 'border-red-500/60 focus-visible:ring-red-500' : 'border-gray-200 focus-visible:ring-primary'
                    }`}
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <button
                    type="button"
                    className="absolute right-3 top-2.5 rounded-full p-1 text-gray-400 hover:text-gray-700"
