        ...
        <main className="flex-1 p-4 sm:p-6 overflow-x-hidden">
          ...
          {activeView === 'buy' ? (
            ...
            <div className="space-y-6">
              {/* Info Banner */}
              <div className="app-card-accent border-blue-200 rounded-lg p-6">
              ...
              <div className="flex gap-4 items-center">
                <div className="px-6 py-3 rounded-lg font-semibold app-btn-primary">
                  BTC
                </div>
              ...
              {!selectedPlan && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {currentPlans.map((plan) => {
                    ...
                    return (
                      <Card key={plan.id} className="app-card border-gray-200 overflow-hidden">
                        {/* Header */}
              ...
              {purchaseStage === 'form' && selectedPlan && (
                <div className="rounded-xl border border-gray-200 bg-white p-6">
                  ...
                  <p className="text-sm text-gray-500 mb-6">
                    ...
                    <span className="text-blue-700 font-semibold">{formatUSD(payable)}</span>
                  </p>

                  <form onSubmit={handleSubmitPurchase} className="space-y-6">
                    <div>
                      <Label className="mb-2 block text-gray-700">Select payment method *</Label>
                      <Select
                        value={gateway || undefined}
                        onValueChange={(value) => handleGatewayChange(value as GatewayValue)}
                      >
                        <SelectTrigger className="h-12 app-input">
                          <SelectValue placeholder="Select One" />
                        </SelectTrigger>
                        <SelectContent className="app-input">
                    ...
                    <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-3">
                      ...
                      <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                        <p className="text-xs uppercase tracking-wide text-gray-500">Charge</p>
                        <p className="mt-2 text-lg font-semibold">{charge > 0 ? formatUSD(charge) : '$0.00'}</p>
                      </div>
                      <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                        <p className="text-xs uppercase tracking-wide text-gray-500">Payable</p>
                    ...
                    <Button
                      ...
                      className="h-12 w-full app-btn-primary text-lg font-semibold hover:brightness-110 disabled:opacity-60"
                    >
              ...
              {purchaseStage === 'preview' && previewData && (
                <div className="grid gap-4 sm:gap-6 lg:grid-cols-2">
                  <div className="rounded-xl border border-gray-200 bg-white p-6">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900">Plan Summary</h3>
                    <p className="text-sm text-gray-500">Confirm the details before proceeding</p>
                  ...
                  <div className="rounded-xl border border-gray-200 bg-white p-6">
                    <div className="mb-4 text-sm text-gray-500">Payment Preview</div>
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-gray-500">You will send</span>
                      ...
                      <Button
                        ...
                        className="mt-4 h-12 w-full app-btn-primary hover:brightness-110 disabled:opacity-60"
                      >
              ...
              {purchaseStage === 'payment' && activePurchase && (
                <div className="space-y-6">
                  <div className="rounded-xl border border-gray-200 bg-white p-6">
                    ...
                    <div className="mt-6 rounded-xl border border-gray-200 bg-[#0D1727] p-6 text-center">
                      <p className="text-sm text-gray-500">PLEASE SEND EXACTLY</p>
                      ...
                      <div className="mt-4 flex items-center justify-center gap-2 text-sm">
                        ...
                        <button
                          ...
                          className="rounded-md bg-blue-50 p-2 text-[#2563eb] transition hover:bg-blue-100 shrink-0"
                        >
                          ...
                          {(() => {
                            ...
                            return payQr ? (
                              <img
                                src={payQr}
                                alt="Scan to pay"
                                className="h-48 w-48 rounded-lg border border-gray-200 bg-white p-2 object-contain"
                              />
                            ) : (
                              <div className="flex h-48 w-48 items-center justify-center rounded-lg border border-gray-200 bg-white/5 text-sm text-gray-500">
                                No address
                              </div>
                            );
                          })()}
              ...
              {purchaseStage === 'form' && !selectedPlan && (
                <footer className="mt-12 border-t border-gray-200 pt-8">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                      <h3 className="text-gray-900 font-semibold mb-4 border-b border-[#2563eb] pb-2 inline-block">Quick Links</h3>
                    ...
                    <div>
                      <h3 className="text-gray-900 font-semibold mb-4 border-b border-[#2563eb] pb-2 inline-block">Useful Links</h3>
                      <ul className="space-y-2 text-gray-600 text-sm">
                    ...
                    <div>
                      <h3 className="text-gray-900 font-semibold mb-4 border-b border-[#2563eb] pb-2 inline-block">Contact Info</h3>
                      <ul className="space-y-2 text-gray-600 text-sm">
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              {purchasedPlans.length === 0 ? (
                <div className="text-center py-12 p-6">
                  <p className="text-gray-500 text-lg">No purchased plans yet</p>
                  <Button
                    onClick={() => setActiveView('buy')}
                    className="mt-4 app-btn-primary hover:brightness-110"
                  >
                    Browse Plans
                  </Button>
                </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-gray-50 border-b border-gray-200">
                        <th className="text-left py-4 px-4 text-gray-700 font-semibold">S.N.</th>
                        ...
                        <th className="text-left py-4 px-4 text-gray-700 font-semibold">Return/Day</th>
                        <th className="text-left py-4 px-4 text-gray-700 font-semibold">Total Days</th>
                        <th className="text-left py-4 px-4 text-gray-700 font-semibold">Remaining Days</th>
                    ...
                    <tbody>
                      {purchasedPlans.map((plan) => (
                        <tr key={plan.id} className="border-b border-gray-200 hover:bg-gray-50">
                          <td className="py-4 px-4 text-gray-700">{plan.sn}</td>
                          <td className="py-4 px-4 text-gray-700">{plan.planName}</td>
                          <td className="py-4 px-4 text-gray-700">{plan.price} USD</td>
                          <td className="py-4 px-4 text-gray-700">
                            {plan.returnPerDay.min.toFixed(8)} - {plan.returnPerDay.max.toFixed(8)} {plan.returnPerDay.currency}
                          </td>
                          <td className="py-4 px-4 text-gray-700">{plan.totalDays}</td>
                          <td className="py-4 px-4 text-gray-700">{plan.remainingDays}</td>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 font-mono text-xs overflow-hidden">
                <div className="bg-white px-3 py-2 border-b border-gray-200 mb-3 rounded-t">
                  <span className="text-green-400">miner@cryptohash</span>
                  <span className="text-gray-500"> ~ </span>
                  <span className="text-[#2563eb]">stratum+tcp:</span>
                </div>
                <div className="space-y-1 text-gray-700 max-h-64 overflow-y-auto" id="mining-log-container">
                  {miningLogs.length > 0 ? (
                    miningLogs.map((log, index) => {
                      ...
                      return (
                        <div
                          key={index}
                          className={isGreen ? 'text-green-400' : isYellow ? 'text-[#2563eb]' : isCommand ? 'text-gray-500' : 'text-gray-500'}
                    ...
                    <>
                      <div className="text-gray-500">[2026-01-17 19:34:27] Switched to Tether mining</div>
                      <div className="text-gray-500">$ cryptohash-miner --start --algo=sha256d --coin=USDT --target=100 --payout=0xd239b1cb8f...a89d63</div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white border border-gray-200 rounded-lg p-6 text-center">
                  ...
                  <div className="text-gray-500 text-sm">MINED (USD)</div>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-6 text-center">
                  <div className="text-3xl font-bold text-[#2563eb] mb-2">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 text-center">
                  ...
                  <div className="text-gray-500 text-sm">HASHRATE</div>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-6 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 flex flex-col gap-1">
                  <Button
                    ...
                    className="w-full app-btn-primary hover:brightness-110 font-semibold text-lg py-6 disabled:opacity-60 disabled:pointer-events-none"
                  >
                    {isSessionActive ? 'Mining...' : 'Start New Session'}
                  </Button>
                  {userBalance <= 0 && !isSessionActive && miningEnabled && (
                    <p className="text-gray-500 text-xs">Balance must be greater than zero to mine. Deposit first.</p>
                  )}
                </div>
                <Button
                  onClick={() => {
                  ...
                  variant="outline"
                  className="flex-1 border-gray-200 text-gray-700 hover:bg-gray-50 font-semibold text-lg py-6"
                >
                  Withdraw
                </Button>
              </div>
          ...
          <Dialog open={showWithdrawModal} onOpenChange={setShowWithdrawModal}>
            <DialogContent className="bg-white border-blue-200 text-gray-900 max-w-md [&>button]:hidden">
              <DialogHeader className="relative">
                <DialogTitle className="text-gray-900 text-xl font-bold mb-4 pr-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-3 pt-4">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full border-blue-200 text-[#2563eb] hover:bg-blue-50"
                  >
                    Go to Deposit Page
                  </Button>
                  <Button
              ...
              {selectedPurchasedPlan && (
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Purchased Date:</span>
                    <span className="text-gray-900 font-medium">{selectedPurchasedPlan.purchasedDate}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Plan Title:</span>
                    <span className="text-gray-900 font-medium">{selectedPurchasedPlan.planName}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Plan Price:</span>
                    <span className="text-gray-900 font-medium">{selectedPurchasedPlan.price} USD</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Miner:</span>
                    <span className="text-gray-900 font-medium">{selectedPurchasedPlan.miner}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Return /Day:</span>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-gray-900 font-medium">{selectedPurchasedPlan.totalDays}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Fixed Return:</span>
                    <span className="text-gray-900 font-medium">{selectedPurchasedPlan.fixedReturn} {selectedPurchasedPlan.returnPerDay.currency}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Remaining Days:</span>
                    <span className="text-gray-900 font-medium">{selectedPurchasedPlan.remainingDays}</span>
                  </div>
                </div>
              )}
            </DialogContent>
