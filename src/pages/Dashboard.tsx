          ...
          <nav className="hidden md:flex items-center gap-4 lg:gap-6">
            <button
              ...
              className={`text-sm font-medium transition-colors ${
                activeView === 'dashboard' ? 'text-[#2563eb]' : 'text-gray-600 hover:text-gray-900'
              }`}
            >
              Home
            </button>
            <button
              ...
              className={`text-sm font-medium transition-colors ${
                activeView === 'team' ? 'text-[#2563eb]' : 'text-gray-600 hover:text-gray-900'
              }`}
            >
              Team
            </button>
            <button
              ...
              className={`text-sm font-medium transition-colors ${
                activeView === 'about-us' ? 'text-[#2563eb]' : 'text-gray-600 hover:text-gray-900'
              }`}
            >
              AboutUs
            </button>
        ...
        <main className="flex-1 p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-x-hidden">
          ...
          {activeView === 'my-referrals' && (
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white shadow-sm p-4">
                <div className="flex items-center gap-4">
                  <span className="text-gray-600">USDT</span>
                  <span className="text-gray-900 text-lg font-semibold">{commission.toFixed(4)}</span>
                </div>
              ...
              <div className="space-y-2">
                <Label className="text-gray-600">USDT Wallet Address (Require TRC20)</Label>
              ...
              <div className="space-y-2">
                <Label className="text-gray-600">Your Referral Link</Label>
                <div className="flex gap-2">
                  <Input
                    value={referralLink}
                    readOnly
          ...
          {activeView === 'referral-bonus-logs' && (
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Referral Bonus Logs</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
          ...
          {activeView === 'withdraw-logs' && (
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Withdraw Logs</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
                  <thead className="bg-gray-50 text-gray-900">
                    <tr>
                  ...
                  <tbody className="text-gray-700">
                    {withdrawLogs.length === 0 ? (
                      <tr>
                        <td colSpan={8} className="py-8 text-center text-gray-900">
                          No Data Found!
                        </td>
                      </tr>
                    ) : (
                        ...
                        <tr key={index} className="border-t border-gray-200">
                          ...
                          <td className="py-3 px-4">
                            <span className={`px-2 py-1 rounded text-xs ${
                              ...
                              log.status === 'pending' ? 'bg-blue-50 text-[#2563eb]' :
                          ...
                          <td className="py-3 px-4">
                            <button className="text-[#2563eb] hover:text-blue-700">View</button>
                          </td>
                        </tr>
                      ))
                    )}
          ...
          {activeView === 'support-new' && (
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Open New Ticket</h2>
              </div>
              ...
              <form 
                ...
                className="rounded-lg border border-gray-200 bg-white shadow-sm p-6 space-y-4"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full bg-gray-50 text-gray-900 border border-gray-200 rounded-md px-3 py-2 outline-none focus:ring-1 focus:ring-[#2563eb]"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    required
                    className="bg-white text-gray-900 border-gray-200 min-h-[200px]"
                ...
                <Button
                  ...
                  className="w-full bg-[#2563eb] text-white hover:bg-blue-700 mt-6"
                >
                  ...
                  <table className="w-full text-left text-sm">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {tickets.length === 0 ? (
                        ...
                        tickets.map((ticket) => (
                          <tr key={ticket.id} className="text-gray-700 hover:bg-gray-50 transition-colors">
                            <td className="py-4 px-6">
                              <div className="font-medium text-gray-900">{ticket.subject}</div>
                              <div className="text-xs text-gray-400 mt-1">Ticket ID: #{ticket.id.slice(0, 8)}</div>
                            </td>
                            <td className="py-4 px-6">
                              <span className={`px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${
                                ...
                                ticket.status === 'resolved' ? 'bg-blue-50 text-[#2563eb] border border-blue-200' :
                            ...
                            <td className="py-4 px-6">
                              <Button
                                variant="ghost"
                                size="sm"
                                className="text-[#2563eb] hover:text-blue-700 hover:bg-blue-50"
                                onClick={() => {
          ...
          {activeView === 'profile' && (
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-gray-900">Profile Setting</h2>
              <form 
                onSubmit={async (e) => {
                  e.preventDefault();
                  try {
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label className="text-gray-600">E-mail Address</Label>
                    <Input
                      type="email"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <select
                        ...
                        className="bg-[#2563eb] text-white px-3 py-2 rounded border-gray-200"
                      >
          ...
          {activeView === 'wallets' && (
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold text-gray-900">User Coin Wallets</h2>
          ...
          {activeView === '2fa-security' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-6 space-y-4">
                <h2 className="text-2xl font-semibold text-gray-900">Add Your Account</h2>
                ...
                <div className="space-y-2">
                  <Label className="text-gray-600">Setup Key</Label>
                  <div className="flex gap-2">
                    <Input
                      value={setupKey}
                      readOnly
                ...
                <div className="space-y-2 pt-4 border-t border-gray-200">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-900 font-semibold">Help</span>
                  </div>
              ...
              <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-6 space-y-4">
                <h2 className="text-2xl font-semibold text-gray-900">Enable 2FA Security</h2>
                <div className="space-y-2">
                  <Label className="text-gray-600">Google Authenticator OTP</Label>
                  <Input
                    value={otp}
          ...
          {activeView === 'change-password' && (
            <div className="space-y-6">
              ...
              <form
                ...
                className="rounded-lg border border-gray-200 bg-white shadow-sm p-6 space-y-4 max-w-2xl"
              >
                <div className="space-y-2">
          ...
          {activeView === 'team' && (
            <div className="space-y-12 pb-12">
              ...
              <div className="space-y-6">
                <div>
                  <h2 className="text-3xl font-bold text-gray-900 mb-2">Core Leadership</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="border border-gray-200 bg-white shadow-sm">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 text-center mb-2">Alexander Wright</h3>
                  ...
                  <div className="border border-gray-200 bg-white shadow-sm">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 text-center mb-2">Sophia Smith</h3>
                    <p className="text-gray-600 text-center mb-3">CTO & Head of Research</p>
                    <p className="text-gray-700 text-sm text-left">
                  ...
                  <div className="border border-gray-200 bg-white shadow-sm">
                    ...
                    <p className="text-gray-600 text-center mb-3">COO & Strategic Partnerships</p>
                    <p className="text-gray-700 text-sm text-left">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
                <div className="space-y-6 relative">
                  ...
                  <div className="relative">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Revolutionizing Crypto Mining</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                      <div>
                        ...
                        <div className="text-gray-600 text-sm">Mining Rigs</div>
                      </div>
                      <div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="border border-gray-200 bg-white shadow-sm">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 text-center mb-1">David Kim</h3>
                    <p className="text-gray-600 text-center mb-3 text-sm">Backend Developer</p>
                    <p className="text-gray-700 text-sm text-left">
                  ...
                  <div className="border border-gray-200 bg-white shadow-sm">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 text-center mb-1">Abraham Johnson</h3>
                    <p className="text-gray-600 text-center mb-3 text-sm">Hardware Engineer</p>
                    <p className="text-gray-700 text-sm text-left">
                  ...
                  <div className="border border-gray-200 bg-white shadow-sm">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 text-center mb-1">James Wilson</h3>
                    <p className="text-gray-600 text-center mb-3 text-sm">Security Specialist</p>
                    <p className="text-gray-700 text-sm text-left">
                  ...
                  <div className="border border-gray-200 bg-white shadow-sm">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 text-center mb-1">Jack Thompson</h3>
                    <p className="text-gray-600 text-center mb-3 text-sm">Data Analyst</p>
                    <p className="text-gray-700 text-sm text-left">
                  ...
                  <div className="border border-gray-200 bg-white shadow-sm">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 text-center mb-1">Robert Williams</h3>
                    <p className="text-gray-600 text-center mb-3 text-sm">Operations Manager</p>
                    <p className="text-gray-700 text-sm text-left">
                  ...
                  <div className="border border-gray-200 bg-white shadow-sm">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 text-center mb-1">Olivia Martinez</h3>
                    <p className="text-gray-600 text-center mb-3 text-sm">Client Relations</p>
                    <p className="text-gray-700 text-sm text-left">
              ...
              <div className="space-y-6">
                <h2 className="text-3xl font-bold text-gray-900 text-center">Supported Cryptocurrencies</h2>
          ...
          {activeView === 'about-us' && (
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                {/* Why Choose Us */}
                <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-8">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Why Choose BtcCloudBase?</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">Daily Payouts</h3>
                      <p className="text-gray-600 text-sm">
                ...
                <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-gray-600">Mined Value</div>
                    </div>
                    <div className="text-center">
                ...
                <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-8">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <a href="mailto:support@BtcCloudBase.com" className="text-gray-600 hover:text-[#2563eb] transition-colors">
                        support@BtcCloudBase.com
                      </a>
                    </div>
                    <div className="flex items-center gap-3">
                      <WhatsAppIcon className="h-5 w-5 text-[#2563eb]" />
                      <a 
                        href={WHATSAPP_LINK} 
                        target="_blank" 
                    ...
                    <div className="flex items-center gap-3">
                      <TelegramIcon className="h-5 w-5 text-[#2563eb]" />
                      <a 
          ...
          {activeView === 'dashboard' && (
            <>
          <section className="rounded-2xl border border-gray-200 bg-white shadow-sm p-6 text-sm leading-relaxed text-gray-700">
            <h2 className="mb-3 text-lg font-semibold text-gray-900">{copy.heroTitle}</h2>
            <p>{copy.heroBody1}</p>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            <Card className="bg-white shadow-sm border-gray-200">
              <CardHeader className="pb-2">
                <CardTitle className="text-gray-900">Balance</CardTitle>
            ...
            <Card className="bg-white shadow-sm border-gray-200">
              <CardHeader className="pb-2">
                <CardTitle className="text-gray-900">Referral Bonus</CardTitle>
            ...
            <Card className="bg-white shadow-sm border-gray-200">
              <CardHeader className="pb-2">
                <CardTitle className="text-gray-900">BtcCloudBase</CardTitle>
                <CardDescription className="text-[#2563eb]">Start Mining</CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col gap-3">
                <p className="text-gray-600">Start your Miner</p>
                <Button 
                  className="w-fit bg-[#2563eb] text-white hover:bg-blue-700"
          ...
          <section className="grid gap-6 md:grid-cols-3">
            <Card className="border-gray-200 bg-white shadow-sm">
              <CardHeader>
                <CardTitle className="text-gray-900">Deposit</CardTitle>
                <CardDescription className="text-gray-500">Secure Coinbase gateway</CardDescription>
              </CardHeader>
              <CardContent>
                <Button 
                  className="w-full bg-[#2563eb] text-white hover:bg-blue-700"
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              <CardHeader>
                <CardTitle className="text-gray-900">Withdraw</CardTitle>
                <CardDescription className="text-gray-500">Request payouts seamlessly</CardDescription>
              </CardHeader>
              <CardContent>
                <Button 
                  className="w-full bg-[#2563eb] text-white hover:bg-blue-700"
          ...
          <section className="grid gap-6">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-6">
              <h4 className="mb-4 text-xl font-semibold text-gray-900">Account Information</h4>
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 capitalize">
                  <p className="font-medium text-gray-600">Account Type</p>
                  <p className="text-gray-900">{profile?.role}</p>
                </div>
                <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 px-4 py-3">
                  <p className="font-medium text-gray-600">Member Since</p>
                  <p className="text-gray-900">{profile?.created_at ? new Date(profile.created_at).toLocaleDateString() : 'N/A'}</p>
                </div>
              </div>
              ...
              <div className="mt-6 rounded-xl border border-blue-200 bg-blue-50 p-4">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <p className="text-sm text-gray-600">Need live help?</p>
                    <p className="font-medium text-gray-900">Contact our support team anytime</p>
                  </div>
                  <Button 
                    variant="outline" 
                    className="border-[#2563eb] bg-white text-[#2563eb] hover:bg-blue-100 shrink-0"
                    onClick={() => setActiveView('support-new')}
                  >
                ...
                <p className="mt-4 text-sm text-gray-600">support@btccloudbase.com</p>
              </div>
            </div>
          </section>

          <footer id="about-section" className="rounded-2xl border border-gray-200 bg-white shadow-sm p-6 text-sm text-gray-600">
            <div className="grid gap-6 lg:grid-cols-3">
              <div>
                <h5 className="text-lg font-semibold text-gray-900">BtcCloudBase</h5>
                <p className="mt-2">
              ...
              <div>
                <h5 className="text-lg font-semibold text-gray-900">Quick Links</h5>
              ...
              <div>
                <h5 className="text-lg font-semibold text-gray-900">Useful Links</h5>
                <ul className="mt-2 space-y-1">
                  <li>Usage Policy</li>
                  <li>Cookie Policy</li>
            ...
            <p className="mt-6 text-center text-xs text-gray-400">Copyright © 2020–2026 BtcCloudBase All Rights Reserved</p>
          </footer>
            </>
          )}
        </main>
