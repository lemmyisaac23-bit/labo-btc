...
const Deposit = () => {
  ...
  return (
    <div className="app-page">
      <AppTopBar onSignOut={handleSignOut} />
      <div className="flex">
        <UserSidebar
        ...
        <main className="flex-1 p-4 sm:p-6 overflow-x-hidden">
          ...
          {activeView === 'deposit' ? (
            <div className="space-y-6">
              <div className="app-card-accent p-6">
                <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Offer Only For Today</p>
                <h2 className="mt-2 text-2xl font-semibold text-[#1e3a5f]">Boost every large deposit</h2>
              ...
              {depositStage === 'form' && (
                <div className="rounded-xl border border-gray-200 bg-white p-6">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      <Label className="mb-2 block text-gray-700">Select Gateway *</Label>
                      <Select
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          className="h-12 flex-1 app-input"
                          min={limit.min > 0 ? limit.min : undefined}
                          max={limit.max > 0 ? limit.max : undefined}
                          step="0.01"
                        />
                        <Button type="button" className="h-12 app-btn-primary px-6">
                          USD
                        </Button>
                      </div>
                    </div>
                    ...
                    <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-3">
                      <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                        <p className="text-xs uppercase tracking-wide text-gray-500">Limit</p>
                    ...
                    <Button
                      ...
                      className="h-12 w-full app-btn-primary text-lg font-semibold hover:brightness-110"
                    >
              ...
              {depositStage === 'preview' && previewData && (
                <div className="grid gap-4 sm:gap-6 lg:grid-cols-2">
                  <div className="rounded-xl border border-gray-200 bg-white p-6">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900">Deposit Summary</h3>
                  ...
                  <div className="rounded-xl border border-gray-200 bg-white p-6">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-gray-500">In {previewData.currency}</span>
                      ...
                      <Button
                        ...
                        className="mt-4 h-12 w-full app-btn-primary hover:brightness-110"
                      >
                    ...
                    <div className="mt-6 rounded-xl border border-gray-200 bg-[#0D1727] p-6 text-center">
                      ...
                      <div className="mt-4 flex items-center justify-center gap-2 text-sm">
                        ...
                        <button
                          ...
                          className="rounded-md bg-blue-50 p-2 text-[#2563eb] transition hover:bg-blue-100"
                        >
                      ...
                      <Button
                        ...
                        className="mt-6 h-12 w-full app-btn-primary hover:brightness-110 font-semibold"
                      >
                        I Have Paid
                      </Button>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-4">
                      <Button
                        ...
                        className="flex-1 app-btn-primary hover:brightness-110 font-semibold"
                      >
                        OK, I Understand
                      </Button>
                    </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="px-4 py-4 text-left font-semibold text-gray-700">Transaction ID</th>
                      <th className="px-4 py-4 text-left font-semibold text-gray-700">Gateway</th>
                      <th className="px-4 py-4 text-left font-semibold text-gray-700">Amount</th>
                      <th className="px-4 py-4 text-left font-semibold text-gray-700">Crypto</th>
                      <th className="px-4 py-4 text-left font-semibold text-gray-700">Status</th>
                      <th className="px-4 py-4 text-left font-semibold text-gray-700">Time</th>
                      <th className="px-4 py-4 text-left font-semibold text-gray-700">More</th>
                    </tr>
                  </thead>
                  <tbody>
                    {deposits.length === 0 ? (
                      ...
                      deposits.map((deposit: any) => (
                        <tr key={deposit.id} className="border-b border-gray-200">
                          <td className="px-4 py-4 font-mono text-sm text-gray-700">{deposit.transaction_id}</td>
                          <td className="px-4 py-4 capitalize text-gray-700">{deposit.gateway}</td>
