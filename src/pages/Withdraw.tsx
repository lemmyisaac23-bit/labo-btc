    ...
    <div className="app-page">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          ...
          {activeView === 'withdraw' ? (
            /* Withdraw Now View */
            <div className="bg-white app-card p-6 max-w-2xl">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="bg-white text-black border-gray-200 h-12"
                    min="0"
                    step="0.01"
                  />
                ...
                {/* Gateway Selection */}
                <div>
                  <Label htmlFor="gateway" className="text-gray-700 mb-2 block">
                    Select Gateway *
                  </Label>
                  <Select value={gateway} onValueChange={setGateway}>
                    ...
                    <SelectContent className="bg-white border-gray-200">
                      <SelectItem value="btc" className="text-gray-900 hover:bg-gray-50 focus:bg-blue-50">
                        BTC
                      </SelectItem>
                      <SelectItem value="usdt-trc20" className="text-gray-900 hover:bg-gray-50 focus:bg-blue-50">
                        USDT.TRC20
                      </SelectItem>
                      <SelectItem value="usdt-erc20" className="text-gray-900 hover:bg-gray-50 focus:bg-blue-50">
                        USDT.ERC20
                      </SelectItem>
                      <SelectItem value="usdc" className="text-gray-900 hover:bg-gray-50 focus:bg-blue-50">
                        USDC
                      </SelectItem>
                      <SelectItem value="eth" className="text-gray-900 hover:bg-gray-50 focus:bg-blue-50">
                        ETH
                      </SelectItem>
                      <SelectItem value="solana" className="text-gray-900 hover:bg-gray-50 focus:bg-blue-50">
                        Solana (SOL)
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                {/* Wallet Address */}
                <div>
                  <Label htmlFor="wallet" className="text-gray-700 mb-2 block">
                    Wallet Address *
                  </Label>
                  <Input
                    id="wallet"
                ...
                <Button
                  type="submit"
                  className="w-full app-btn-primary hover:brightness-110 h-12 text-lg font-semibold"
                >
                  Submit Withdrawal
                </Button>
              </form>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      <th className="text-left py-4 px-4 text-gray-700 font-semibold">Time</th>
                      <th className="text-left py-4 px-4 text-gray-700 font-semibold">Transaction ID</th>
                      <th className="text-left py-4 px-4 text-gray-700 font-semibold">Wallet</th>
