  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 text-[#2563eb]">Terms of Service</h1>
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">3. Mining Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">4. User Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">5. Payments and Refunds</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">7. Revisions and Errata</h2>
            <p>
