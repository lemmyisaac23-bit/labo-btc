    ...
    <section className="py-24 px-4 bg-[#070f1e] relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <span className="inline-block text-xs font-semibold tracking-widest text-yellow-400/80 uppercase mb-4 border border-[#2563eb]/20 rounded-full px-4 py-1 bg-yellow-500/5">
            Why BtcCloudBase?
          </span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => (
            ...
            >
              {/* Number watermark */}
              <span className="absolute top-4 right-5 text-6xl font-black text-white/[0.04] select-none group-hover:text-gray-900/[0.07] transition-colors">
                {feature.num}
              </span>
