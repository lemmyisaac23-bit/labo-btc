    ...
    <div className="fixed bottom-6 right-6 z-[1000] flex flex-col items-end gap-4">
      {contacts.map(({ label, href, icon: Icon, glow }) => (
        ...
        >
          ...
          />
          <div className="relative rounded-full bg-gray-50 border border-gray-200 shadow-lg shadow-black/40">
            <div className="h-14 w-14 flex items-center justify-center rounded-full bg-gradient-to-br from-white to-gray-50 text-[#2563eb] transition-transform duration-300 group-hover:scale-105">
