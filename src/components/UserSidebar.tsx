  ...
  return (
    <>
      ...
      <Button
        variant="ghost"
        size="icon"
        className="lg:hidden text-gray-700 hover:bg-gray-100 fixed top-4 left-4 z-50"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-40 lg:z-auto w-64 min-h-screen bg-white border-r border-gray-200 p-4 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        {onSignOut && (
          <div className="mt-8 pt-8 border-t border-gray-200">
            <Button
              variant="outline"
              className="w-full app-logout-btn"
              onClick={onSignOut}
            >
